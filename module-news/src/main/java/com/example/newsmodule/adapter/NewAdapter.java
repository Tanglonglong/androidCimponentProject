package com.example.newsmodule.adapter;
...
public class NewAdapter extends RecyclerView.Adapter<NewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.news_m_news_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(mContext)  // 绑定生命周期（Activity/Fragment/View）
                ...
                .placeholder(R.mipmap.news_m_ic_launcher)  // 加载中占位图
                .error(R.mipmap.news_m_ic_launcher)  // 加载失败图
